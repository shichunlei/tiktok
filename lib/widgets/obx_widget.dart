...
import 'package:tiktok/global/enum.dart';
import 'package:tiktok/widgets/state_view/empty_page.dart';
import 'package:tiktok/widgets/state_view/error_page.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if (logic.pageState.value == ViewState.empty && showEmpty) {
        return EmptyPage(onRetry: onRetry, height: height, text: emptyTip, bgColor: bgColor);
      }
