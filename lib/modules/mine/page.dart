      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          AvatarImageView("https://img.zcool.cn/community/0107c35ba37431a801213dea3bc6d2.jpg@1280w_1l_2o_100sh.jpg",
              radius: 35.r, borderColor: Colors.white, borderWidth: 1),
          SizedBox(width: 15.w),
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
              Text("XXX123", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 15.sp)),
              Container(
                  ...
                  child: Text("1year",
                      style: TextStyle(color: const Color(0xffF8C702), fontWeight: FontWeight.w600, fontSize: 14.sp)))
            ]),
          ),
          SizedBox(width: 15.w)
        ]),
        Container(
            ...
            child: Column(children: [
              ...
              Row(children: [
                Text("10%",
                    style: TextStyle(color: const Color(0xffF9632A), fontSize: 38.sp, fontWeight: FontWeight.w600)),
                SizedBox(width: 20.w),
        ...
        Row(children: [
          ...
          GestureDetector(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                Icon(Icons.manage_accounts, color: Colors.white, size: 25.r),
          ...
          GestureDetector(
              ...
              behavior: HitTestBehavior.translucent,
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                Icon(Icons.exit_to_app_sharp, color: Colors.white, size: 25.r),
                SizedBox(height: 10.h),
