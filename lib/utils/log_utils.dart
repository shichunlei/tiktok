...
/// 输出Log工具类
class Log {
  static d(Object msg, {eventName = 'TIKTOK-LOG', action = '   d   '}) {
    _print(msg, eventName: eventName, action: action);
  }

  static i(String msg, {eventName = 'TIKTOK-LOG', action = '   i   '}) {
    _print(msg, eventName: eventName, action: action);
  }

  static e(String msg, {eventName = 'TIKTOK-LOG', action = '   e   '}) {
    _print(msg, eventName: eventName, action: action);
  }

  static json(Map<String, dynamic> msg, {eventName = 'TIKTOK-LOG', action = '   json   '}) {
    _print(convert.json.encode(msg), eventName: eventName, action: action);
  }

  static _print(Object? msg, {eventName = 'TIKTOK-LOG', action = '   v   '}) {
